...
class ExtraChargeFlatBuilder private constructor() {
    ...
    private var extraChargeFlat = ExtraChargesFlat(
    ...
    fun withChargeType(chargeType: ChargeType): ExtraChargeFlatBuilder = this.apply {
        this.extraChargeFlat = extraChargeFlat.copy(chargeType = chargeType)
    }

    fun withPrice(price: BigDecimal): ExtraChargeFlatBuilder = this.apply {
