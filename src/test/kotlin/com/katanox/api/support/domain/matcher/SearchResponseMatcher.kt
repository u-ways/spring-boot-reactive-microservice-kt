...
class SearchResponseMatcher private constructor(
    ...
    override fun matchesSafely(item: String) =
        JsonPath
            .from(item)
    ...
    companion object {
        @JvmStatic
        fun searchResponse(vararg availabilityResponse: AvailabilityResponse) = SearchResponseMatcher(availabilityResponse.toList())
    }
}
